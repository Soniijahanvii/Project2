...
const Pricing = () => {
  return (
    <>
      ...
      <div id="#pricing" className="mt-44">
        <div className="">
          <div>
          ...
          <div className="flex justify-center mt-20 gap-20">
            <div className="border border-black rounded-2xl p-4  shadow-2xl">
              <h1 className="text-2xl text-gray-800 font-bold ml-2">Free</h1>
              <h1 className="text-6xl font-bold flex mt-2">
                Free <p className="text-lg font-bold mt-8 ml-1">forever</p>
              </h1>
              ...
              <ul className="list-disc pl-6 pr-4 text-xl mt-4">
            ...
            <div className="border border-black rounded-2xl p-4">
              <h1 className="text-2xl text-gray-800 font-bold ml-2">
                Essentials
              </h1>
              <h1 className="text-6xl font-bold flex mt-2">
                $10 <p className="text-lg font-bold mt-8 ml-1">/month</p>
              </h1>
            ...
            <div className="border border-black rounded-2xl p-4">
              <h1 className="text-2xl text-gray-800 font-bold ml-2">Team</h1>
              <h1 className="text-6xl font-bold flex mt-2">
                $20 <p className="text-lg font-bold mt-8 ml-1">/month</p>
              </h1>
              <p className="text-gray-700 mt-2">
